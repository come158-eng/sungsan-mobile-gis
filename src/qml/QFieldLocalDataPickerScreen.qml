...
Page {
  ...
  header: QfPageHeader {
    ...
    showMenuButton: localFilesModel.inSelectionMode && ((!appIsSungsan && table.selectedItemsPushableToQField) || table.selectedItemsWebDavConfigured || table.selectedItemsDeletable)
  ...
  ColumnLayout {
            ...
            ParameterizedImage {
              ...
              source: {
                ...
                case LocalFilesModel.ApplicationFolder:
                  return Theme.getThemeVectorIcon(appIsSungsan ? 'ic_folder_param_48dp' : 'ic_folder_qfield_param_48dp');
    ...
    QfMenu {
      ...
      MenuItem {
        ...
        enabled: !appIsSungsan && ((itemMenu.itemMetaType == LocalFilesModel.File) || (itemMenu.itemMetaType == LocalFilesModel.Dataset && itemMenu.itemType == LocalFilesModel.RasterDataset && cloudProjectsModel.currentProjectId) || (itemMenu.itemMetaType == LocalFilesModel.Folder && itemMenu.itemWithinQFieldCloudProjectFolder))
        visible: enabled
    ...
    QfMenu {
      ...
      MenuItem {
        ...
        onTriggered: {
          if (appIsSungsan) {
            mainWindow.sungsanExportCurrentProject();
          } else {
    ...
    QfMenu {
      ...
      MenuItem {
        ...
        enabled: !appIsSungsan && table.selectedItemsPushableToQField
        visible: enabled
