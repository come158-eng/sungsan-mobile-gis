...
Page {
  ...
  ColumnLayout {
    ...
    Label {
      ...
      text: appIsSungsan
              ? "PC의 QGIS 프로젝트에서 데이터 원본 경로를 상대 경로로 설정한 뒤 현장용 패키지를 다시 만들어 주세요."
              : qsTr('You may check the %1Portable Project%2 documentation page for more help.').arg("<a href=\"https://docs.qfield.org/how-to/project-setup/data_source_and_project_paths/\">").arg("</a>")
