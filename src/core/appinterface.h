...
class AppInterface : public QObject
{
  ...
  public:
    ...
    /**
     * Writes the currently opened QGIS project to disk.
     *
     * Feature forms commit their edits through the existing QField engine;
     * this method persists project-level state for the Sungsan manual and
     * timed save controls.
     *
     * \returns TRUE when a project was open and successfully written.
     */
    ...
    /**
     * Clears the currently opened project and returns TRUE when its pending
     * database WAL files were safely checkpointed.
     */
    Q_INVOKABLE bool clearProject() const;
