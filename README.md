...
# Sungsan Mobile GIS 1.2.2 정식 소스
...
- 성산 홈: 일반 기본 현장 프로젝트 만들기, 현장 패키지 가져오기, 기기 프로젝트, 최근 현장
- 성산 현장 패널: 외부 GNSS, 레이어, 조사 시작, 기존 지점 편집, 수동·5분 자동 저장, ZIP 내보내기
- LandStar 공유: PXY/KOF/TXT/CSV 자동 수신, 확인된 좌표계에서 측점명 기준 추가·갱신
- 지점 사진: 모든 편집 가능한 조사 레이어의 근경·원경·기타·기타2 고정 사진, 타점명 기반 파일명, 사진 하단 흰색 이름표, `Pictures/성산 GIS` 갤러리 사본
