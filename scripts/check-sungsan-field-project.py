...
check("home emits create signal", "root.createFieldProjectRequested()" in HOME)
...
check("created project loads immediately", "iface.loadFile(projectFilePath, projectTitle)" in handler)
